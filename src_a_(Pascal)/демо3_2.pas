...
//заполнение таблицы
  sqlВыполнить(соединение,"INSERT INTO Работники (Табельный,ФамилияИО) VALUES (0001,'Иванов С.А.');");
  sqlВыполнить(соединение,"INSERT INTO Работники (Табельный,ФамилияИО) VALUES (0002,'Петров П.Р.');");
  sqlВыполнить(соединение,"INSERT INTO Работники (Табельный,ФамилияИО) VALUES (0003,'Сидоров Е.Н.');");
//вывод таблицы
  ...
  while SQLFetch(опер)=SQL_SUCCESS do begin

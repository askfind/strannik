...
function id7(id8:HWND; id9,id10:HTREEITEM; id11:pstr, id12,id13:HBITMAP):HTREEITEM;
var id14:TV_INSERTSTRUCT;
begin
  RtlZeroMemory(addr(id14),sizeof(TV_INSERTSTRUCT));
  with id14,item do begin
  ...
  id7:=HTREEITEM(SendMessage(id8,TVM_INSERTITEM,0,integer(addr(id14))))
end;

//================= create window with tree =======================

procedure id15(id16:HWND; id17:dword);
...
function id27(id8:HWND; id28:pTV_DISPINFO):boolean;
begin
  with id28^.hdr,id28^.item do begin
  case code of
...
begin
  case message of
    WM_INITDIALOG:begin id15(wnd,id4); id19(GetDlgItem(wnd,id4)) end;
    ...
    WM_NOTIFY:case loword(wparam) of
      id4:procDLG_MAIN:=id27(GetDlgItem(wnd,id4),address(lparam));
    end;

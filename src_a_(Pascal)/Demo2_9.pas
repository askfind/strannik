  ...
  case message of
    ...
    case id20^.code of
      ...
      PSN_KILLACTIVE:begin
        if IsDlgButtonChecked(wnd,id3)=BST_CHECKED then id19:=0;
        if IsDlgButtonChecked(wnd,id4)=BST_CHECKED then id19:=1;
        if IsDlgButtonChecked(wnd,id5)=BST_CHECKED then id19:=2;
      end;
    end;
    procDLG_1:=false;
    end;

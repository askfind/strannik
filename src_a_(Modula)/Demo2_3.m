...
procedure id6(id7:HWND; id8:cardinal);
begin
  InitCommonControls();
//range 1 to 100
...
procedure id9(id7:HWND; id8:cardinal);
var id10:integer;
begin
  id10:=SendMessage(GetDlgItem(id7,id8),PBM_DELTAPOS,0,0);
  dec(id10,10);
  if id10<1 then id10:=1 end;
...
procedure id11(id7:HWND; id8:cardinal);
var id10:integer;
begin
  id10:=SendMessage(GetDlgItem(id7,id8),PBM_DELTAPOS,0,0);
  inc(id10,10);
  if id10>100 then id10:=100 end;
  SendMessage(GetDlgItem(id7,id8),PBM_SETPOS,id10,0);
  SetDlgItemInt(id7,id3,id10,true);
end id11;
